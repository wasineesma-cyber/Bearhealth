...
export const FILM_PRESETS: FilmPreset[] = [
...

  {
    ...
    name: "Ricoh GR",
    category: "camera",
    vibe: "สตรีท คอนทราสต์จัด Positive Film",
    filter: "saturate(1.22) contrast(1.2) brightness(1.0)",
    grain: 0.09,
    vignette: 0.24,
    swatch: "#3f3f3f",
  },
  {
    ...
    name: "Nikon L35AF",
    category: "camera",
    vibe: "อุ่นเป็นธรรมชาติ คมชัด",
    filter: "saturate(1.1) contrast(1.06) brightness(1.02) sepia(0.07)",
    tint: { color: "#ffdcae", alpha: 0.08, mode: "soft-light" },
    fade: { color: "#241c12", alpha: 0.1 },
    grain: 0.11,
    vignette: 0.2,
    swatch: "#e8b400",
  },
  {
    ...
    name: "Hasselblad",
    category: "camera",
    vibe: "มีเดียมฟอร์แมต สีธรรมชาติ เนียน",
    filter: "saturate(1.08) contrast(1.03) brightness(1.03) sepia(0.05)",
    tint: { color: "#ffe6c8", alpha: 0.06, mode: "soft-light" },
    fade: { color: "#20211c", alpha: 0.08 },
    grain: 0.04,
    vignette: 0.12,
    swatch: "#cfc9bd",
  },
  {
    id: "yashicaelectro",
    name: "Yashica Electro",
    category: "camera",
    vibe: "เรนจ์ไฟน์เดอร์ อุ่นวินเทจ",
    filter: "sepia(0.2) saturate(1.12) contrast(1.02) brightness(1.04)",
    tint: { color: "#ffcf7a", alpha: 0.1, mode: "soft-light" },
    fade: { color: "#2a2014", alpha: 0.12 },
    grain: 0.13,
    vignette: 0.28,
    swatch: "#d9a24e",
  },
  {
    id: "konicabigmini",
    name: "Konica Big Mini",
    category: "camera",
    vibe: "พาสเทล เขียวโคนิก้า นอสตัลจิก",
    filter: "saturate(1.06) contrast(0.98) brightness(1.04) hue-rotate(-4deg) sepia(0.05)",
    tint: { color: "#a8d8c0", alpha: 0.08, mode: "soft-light" },
    fade: { color: "#1e241e", alpha: 0.12 },
    grain: 0.12,
    vignette: 0.2,
    swatch: "#7ab894",
  },
